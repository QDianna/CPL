...
import cool.semantic.DefinitionPassVisitor;
import cool.semantic.ResolutionPassVisitor;
        ...
        for (var fileName : args) {
            ...
            */
            ...
            if (lexicalSyntaxErrors) {
                System.err.println("Compilation halted - lexical or syntactic errors!");
                return;
            }

            // Create AST
            ProgramNode ast = (ProgramNode) new ASTConstructionVisitor().visit(globalTree);

            // TODO Semantic analysis
            // Populate global scope.
            SymbolTable.defineBasicClasses();

            // Semantic Analysis - Definition Pass
            var definitionPassVisitor = new DefinitionPassVisitor();
            ast.accept(definitionPassVisitor);

            // Semantic Analysis - Resolution Pass
